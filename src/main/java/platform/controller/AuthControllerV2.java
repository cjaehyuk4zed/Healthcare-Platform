...
@Tag(name = "AuthV2", description = "로그인 및 인증 관련 APIs")
public class AuthControllerV2 {
    ...
    public ResponseEntity<String> register(HttpServletRequest request, HttpServletResponse response, @RequestBody AuthenticationRequestDTO requestDTO) throws BadRequestException {
        log.info("AuthController /register : {}", requestDTO);
...
//        새로운 장치에서의 사용자 로그인 감지 방법 고민해볼 것 - IP로는 불안정하다
//        새로운 장치에서의 사용자 로그인 감지 방법 고민해볼 것 - IP로는 불안정하다
//        새로운 장치에서의 사용자 로그인 감지 방법 고민해볼 것 - IP로는 불안정하다
//        새로운 장치에서의 사용자 로그인 감지 방법 고민해볼 것 - IP로는 불안정하다
//        새로운 장치에서의 사용자 로그인 감지 방법 고민해볼 것 - IP로는 불안정하다
...
//        }
    ...
    // Change URL address at logout.logoutUrl("...") to update the LogoutHandler API
